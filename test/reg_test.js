...
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres@localhost:5432/registration_numbers'
...
describe(' The townList function', function () {
  ...
  it('should return a list of all the towns that are in the database', async function () {
    ...
    { id: 5,
      ...
      starts_with: 'CAR' },
    { id: 6, town_name: 'George', starts_with: 'CAW' },
    { id: 7, town_name: 'Ladismith', starts_with: 'CBL' },
    { id: 8, town_name: 'Laingsburg', starts_with: 'CBM' },
    { id: 9, town_name: 'Montagu', starts_with: 'CBR' },
    { id: 10,
      town_name: 'Mossel Bay & Hartenbos',
      starts_with: 'CBS' },
    { id: 11, town_name: 'Murraysburg', starts_with: 'CBT' },
    { id: 12, town_name: 'Piketberg', starts_with: 'CBY' },
    { id: 13, town_name: 'Prince Albert', starts_with: 'CCA' },
    { id: 14,
      town_name: 'Riversdale & Still Bay',
      starts_with: 'CCC' },
    { id: 15, town_name: 'Robertson & McGregor', starts_with: 'CCD' },
    { id: 16,
      town_name: 'Swellendam & Barrydale',
      starts_with: 'CCK' },
    { id: 17, town_name: 'Tulbagh', starts_with: 'CCM' },
    { id: 18, town_name: 'Uniondale', starts_with: 'CCO' },
    { id: 19,
      town_name: 'Vanrhynsdorp & Klawer',
      starts_with: 'CCP' },
    { id: 20, town_name: 'Moorreesburg', starts_with: 'CEA' },
    { id: 21, town_name: 'Heidelberg', starts_with: 'CEG' },
    { id: 22,
      town_name: 'Hermanus, Gans Bay, Onrus River & Stanford',
      starts_with: 'CEM' },
    { id: 23, town_name: 'Grabouw', starts_with: 'CEO' },
    { id: 24, town_name: 'Bonnievale', starts_with: 'CER' },
    { id: 25, town_name: 'Albertinia', starts_with: 'CES' },
    { id: 26, town_name: 'Porterville', starts_with: 'CEX' },
    { id: 27, town_name: 'Strand & Gordons Bay', starts_with: 'CEY' },
    { id: 28, town_name: 'Wolseley', starts_with: 'CFA' },
    { id: 29,
      town_name: 'Vredenburg & St Helena Bay',
      starts_with: 'CFG' },
    { id: 30, town_name: 'Somerset West', starts_with: 'CFM' },
    { id: 31, town_name: 'Velddrif', starts_with: 'CFP' },
    { id: 32,
      town_name: 'Kuilsrivier & Brackenfell',
      starts_with: 'CFR' },
    { id: 33, town_name: 'Oudtshoorn', starts_with: 'CG' },
    { id: 34, town_name: 'Paarl & Franschhoek', starts_with: 'CJ' },
    { id: 35, town_name: 'Malmesbury & Darling', starts_with: 'CK' },
    { id: 36, town_name: 'Stellenbosch', starts_with: 'CL' },
    { id: 37, town_name: 'Wellington', starts_with: 'CN' },
    { id: 38, town_name: 'Calitzdorp', starts_with: 'CO' },
    { id: 39, town_name: 'Hopefield & Langebaan', starts_with: 'CR' },
    { id: 40, town_name: 'Bredasdorp & Napier', starts_with: 'CS' },
    { id: 41, town_name: 'Ceres', starts_with: 'CT' },
    { id: 42, town_name: 'Vredendal', starts_with: 'CV' },
    { id: 43,
    ...
    { id: 45,
      ...
      starts_with: 'CY' },
    { id: 46, town_name: 'Beaufort West', starts_with: 'CZ' } ])
  })
})
